         ...
         <Box component="form" sx={{ '& > :not(style)': { m: 1 } }} style={{color:"#000",display: "flex",flexDirection: "column" ,maxWidth: "100%",minWidth: "30%"}} onSubmit={handleSumit} >
            <Box sx={{ display: 'flex', alignItems: 'flex-end' }}>
               <TextField
                  ...
                  value={dataInfo.name || ""}
                  variant="standard"
                  onChange={(e:any)=> setDataInfo((prev:any)=>({...prev,name:e.target.value}))}
                  fullWidth
                  required
               />
            </Box> 
            <Box sx={{ display: 'flex', alignItems: 'flex-end' }}>
               <TextField
                  ...
                  onChange={(e:any)=> setDataInfo((prev:any)=>({...prev,direccion:e.target.value}))}
                  fullWidth
                  required
               />
            </Box> 
            <Box sx={{ display: 'flex', alignItems: 'flex-end' }}>
               <TextField
                  ...
                  onChange={(e:any)=> setDataInfo((prev:any)=>({...prev,telefono:e.target.value}))}
                  fullWidth
                  required
               />
            </Box> 
